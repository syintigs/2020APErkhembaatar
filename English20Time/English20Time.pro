...
unrealRootPath=/home/jc/UnrealEngine
English20TimeRootPath=/home/jc/2020APErkhembaatar/English20Time

gameProjectFile=/home/jc/2020APErkhembaatar/English20Time/English20Time.uproject
...
include(English20TimeSource.pri)
include(English20TimeHeader.pri)
include(English20TimeConfig.pri)
include(English20TimeIncludes.pri)
include(English20TimeDefines.pri)

English20Time-Linux-Debug.commands = $$build English20Time Linux Debug  -project="\"$$gameProjectFile\"" $$args
English20Time-Linux-DebugGame.commands = $$build English20Time Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
English20Time-Linux-Shipping.commands = $$build English20Time Linux Shipping  -project="\"$$gameProjectFile\"" $$args
English20Time-Linux-Test.commands = $$build English20Time Linux Test  -project="\"$$gameProjectFile\"" $$args
English20Time.commands = $$build English20Time Linux Development  -project="\"$$gameProjectFile\"" $$args

English20TimeEditor-Linux-Debug.commands = $$build English20TimeEditor Linux Debug  -project="\"$$gameProjectFile\"" $$args
English20TimeEditor-Linux-DebugGame.commands = $$build English20TimeEditor Linux DebugGame  -project="\"$$gameProjectFile\"" $$args
English20TimeEditor-Linux-Shipping.commands = $$build English20TimeEditor Linux Shipping  -project="\"$$gameProjectFile\"" $$args
English20TimeEditor-Linux-Test.commands = $$build English20TimeEditor Linux Test  -project="\"$$gameProjectFile\"" $$args
English20TimeEditor.commands = $$build English20TimeEditor Linux Development  -project="\"$$gameProjectFile\"" $$args
...
QMAKE_EXTRA_TARGETS += \ 
	English20Time-Linux-Debug \
	English20Time-Linux-DebugGame \
	English20Time-Linux-Shipping \
	English20Time-Linux-Test \
	English20Time \
	English20TimeEditor-Linux-Debug \
	English20TimeEditor-Linux-DebugGame \
	English20TimeEditor-Linux-Shipping \
	English20TimeEditor-Linux-Test \
	English20TimeEditor \
